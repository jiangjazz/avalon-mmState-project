define(['jquery'], function(){
    ...
    (function (window, undefined) {
        ...
        var node = null;
        var blackList = [];
        var whiteList = ["/api/v1/account/register","/api/v1/account/login","/api/v1/account/reset_password","/api/v1/account/modify_password","/api/v1/account/modify_mobile","/api/v1/account/modify_email","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","/api/v1/account/forgot","/api/v1/account/profile","/api/v1/emailSetting/checkDomain","/api/v1/emailSetting/delete","/api/v1/emailSetting/setting","/api/v1/emailSetting/addSender","/api/v1/emailSetting/addSenderDomain","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","/api/v1/mrtb/setting","/api/v1/mrtb/save","/api/v1/message/signlist","/api/v1/message/signsave","/api/v1/message/signdelete","/api/v1/message/signEdit","/api/v1/invitation/list","/api/v1/account/getMyremind","/api/v1/account/remindSave","/api/v1/product/list","/api/v1/cart/add","/api/v1/cart/list","/api/v1/cart/delete","/api/v1/order/confirm","/api/v1/order/payment","/api/v1/writeRemittanceInfo","/api/v1/order/applyNomalInvoice","/api/v1/order/myorder","/api/v1/specialInvoiceCertificate","/api/v1/invoiceHistory","/api/v1/order/applyNomalInvoice","/api/v1/system/article","/api/v1/system/article/:id/info","/api/v1/system/article/:id/update","/api/v1/role/getPermssion","/api/v1/role/assign","api/v1/role/roleList","/api/v1/admin/account/modify_password","/api/v1/admin/account/modify_mobile","/api/v1/admin/account/modify_email","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","/api/v1/utils/smscode","/api/v1/utils/emailcode","/api/v1/utils/validation","/api/v1/utils/upload","/api/v1/admin/user/userlist","/api/v1/admin/user/info","/api/v1/admin//user/leadSave","/api/v1/admin/user/userDetail","/api/v1/admin/user/credentials","/api/v1/admin/user/credential","/api/v1/admin/user/rankList","/api/v1/admin/user/rankSaveUpdate","/api/v1/admin/user/rankException","/api/v1/admin/productCategroy/save","/api/v1/admin/discount/save","/api/v1/admin/admin/product/save","/api/v1/admin/productCategroy/list","/api/v1/admin/product/list","/api/v1/admin/discount/list","/api/v1/admin/product/add","/api/v1/admin/productCategory/edit","/api/v1/admin/discount/add","/api/v1/admin/productCategroy/delete","/api/v1/admin/product/edit","/api/v1/admin/order/billing","/api/v1/admin/order/billingRecord","/api/v1/admin/order/billingDetail","/api/v1/admin/order/list","/api/v1/admin/order/statistics","/api/v1/admin/order/confirm","/api/v1/admin/order/view","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx","xxxxxxxxxxxxxxxxEMPTY URLxxxxxxxxxxxxxxxxx"];

        var ROOT = "rap.qdum.com";
        var LOST = "LOST";
        var PREFIX = "/mockjs/";
        var EMPTY_ARRAY = "EMPTY_ARRAY";
        var TYPE_NOT_EQUAL = "TYPE_NOT_EQUAL";
